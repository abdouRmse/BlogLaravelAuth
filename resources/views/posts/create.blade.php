...
@section('content')
    <div class="container p-8 my-8 bg-white shadow-2xl shadow-gray-300 mx-auto">
        <form method="post" action="{{route('post.store')}}" enctype="multipart/form-data">
            ...
            <div class="mb-6">  
                <label for="cont" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">The Post Content</label>
                <textarea id="cont" name="content" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"></textarea>
            </div>
